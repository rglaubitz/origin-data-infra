...
**Purpose:** Setup guide for Supabase MCP integration  
**Source:** Context7 - supabase-community/supabase-mcp

---

## Overview

The Supabase MCP allows Claude (and other AI assistants) to:
